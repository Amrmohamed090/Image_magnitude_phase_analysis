...
def get_combined(option,edges1,edges2, uniform_phase_bool,uniform_Magnitude_bool):
    ...
    ImageProcessing_1 = ImageProcessing(edges1,(option == "option1"),uniform_Magnitude_bool,uniform_phase_bool,img_1.getfourier()).get_cropped()
    ImageProcessing_2 = ImageProcessing(edges2,(option != "option1"),uniform_Magnitude_bool,uniform_phase_bool,img_2.getfourier()).get_cropped()
